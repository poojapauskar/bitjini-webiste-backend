...
class UsersSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        msg2=validated_data.get('name')+" with email "+validated_data.get('email')+" and phone "+validated_data.get('phone')+" has contacted Bitjini. Project description is as follows "+validated_data.get('project_description')+" .Interested domain "+domain
